...
transmission of P.vivax takes place in 45 districts of the inner Terai and mid - hills."],
    Nicaragua: ['WHO recommended prevention in risk areas: Type B in P. vivax risk areas', 'C in P. falciparum risk areas ', "Malaria risk due to P. vivax (79.2%) and P. falciparum (20.8%) exists throughout the year in a number of\
...
function initMap() {
    ...
    // var malaria_risk = 'Verylimitedriskofmalaria transmission'
    ...
    // var recommended_prevention_type = group_A, group_B, group_C, group_D

    // {'Afghanistan' : {'recommended_prevention_type' : ["vaccine_a', 'vaccine_b'] }
...
// var prevention = {Afghanistan : ['Group_C'],
//                   Algeria : ['Group_A'],
//                   Angola : ['Group_C'],                
// };

// console.log(prevention['Afghanistan'])
// console.log(prevention['Algeria'])

// var country ='Angola'
// console.log(prevention[country])
// }
